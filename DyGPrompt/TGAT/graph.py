...
class NeighborFinder:
    def __init__(self, adj_list, uniform=False):
        ...
        # print(len(self.node_idx_l))
        # print(len(self.edge_idx_l))
...
#
    ...
    def get_temporal_neighbor_dfs(self, src_idx_l, cut_time_l, num_neighbors=20):
        """
        Params
        ------
        src_idx_l: List[int]
    ...
    def get_temporal_neighbor_bfs(self, src_idx_l, cut_time_l, num_neighbors=20):
        """
        Params
        ------
        src_idx_l: List[int]

...
from roland import DynamicGATModel
import argparse
import sys
...
print(cumulative_snapshots)

# print(cumulative_snapshots[0][0])

model = DynamicGATModel(in_channels = in_channels, hidden_channels=in_channels, out_channels=in_channels)
...
torch.save(model.state_dict(), 'roland_GAT.pth')
